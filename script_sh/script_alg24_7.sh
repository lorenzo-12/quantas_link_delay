...
python run_tests_groups.py --alg "alg24" --list '[["Alg24Peer", "alg24_silent_silent_opposite.json"], ["Alg24Peer", "alg24_silent_silent_same.json"], ["Alg24Peer", "alg24_silent_silent_silent.json"]]'