...
python run_tests_groups.py --alg "alg24" --list '[["Alg24Peer", "alg24_silent_opposite_silent.json"], ["Alg24Peer", "alg24_silent_same_opposite.json"], ["Alg24Peer", "alg24_silent_same_same.json"], ["Alg24Peer", "alg24_silent_same_silent.json"]]'