...
python run_tests_groups.py --alg "alg24" --list '[["Alg24Peer", "alg24_same_silent_same.json"], ["Alg24Peer", "alg24_same_silent_silent.json"], ["Alg24Peer", "alg24_silent_opposite_opposite.json"], ["Alg24Peer", "alg24_silent_opposite_same.json"]]'